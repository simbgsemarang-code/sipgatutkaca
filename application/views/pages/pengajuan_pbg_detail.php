...
$label_status = array('draf' => 'Draf', 'verifikasi_dokumen' => 'Verifikasi Kelengkapan Dokumen');
?>
<!DOCTYPE html>
    ...
    <div class="card">
      ...
      <?php else: ?>
        <?php foreach ($dokumen as $d): ?>
          <div class="doc-item">
            <span><?php echo htmlspecialchars($d['jenis_dokumen'], ENT_QUOTES, 'UTF-8'); ?> — <?php echo htmlspecialchars($d['nama_file_asli'], ENT_QUOTES, 'UTF-8'); ?></span>
