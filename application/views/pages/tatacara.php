...
<html lang="id" data-theme="dark">
  ...
  <head>
    ...
    <title>Tata Cara — SIP Gatutkaca · Kabupaten Cilacap</title>
    ...
    <style>
      ...
      * {
      ...
      .g-item figcaption {
        ...
        background: linear-gradient(0deg, rgba(8, 24, 38, .92), transparent);
        font-family: var(--display);
        letter-spacing: .12em;
        color: #F3E3B8
      }
      ...
      .credit {
        margin-top: 50px;
        padding-top: 22px;
        border-top: 1px solid rgba(185, 199, 210, .15);
        display: flex;
        justify-content: space-between;
        gap: 20px;
        flex-wrap: wrap;
        font-size: .72rem;
        color: rgba(185, 199, 210, .6);
        letter-spacing: .06em
      }
    ...
    <section style="padding-top:calc(84px + 100px)">
      <div class="wrap">
        <div class="reveal">
          ...
          <h2>Jalur yang Lurus, Langkah yang Terang</h2>
          <p class="section-lead">Kami percaya birokrasi yang bermartabat adalah birokrasi yang jelas dan terpercaya. Setiap tahapan layanan penilaian kelayakan bangunan gedung dijabarkan secara efektif dan efisien — lengkap dengan persyaratan dan batas waktunya.</p>
        </div>
        <div class="steps reveal">
          <div class="step">
            <div class="step-num">01</div>
            <div>
              <h3>Tata Cara Pengurusan SIMBG</h3>
              <p>Telusuri pengajuan PBG Anda melalui menu <a href="<?php echo base_url('konsultasi'); ?>" style="color:var(--gold-300)">Konsultasi</a> atau ajukan <a href="<?php echo base_url('itr'); ?>" style="color:var(--gold-300)">PBG dan SLF</a> untuk keterangan resmi tertulis mengenai persetujuan PBG.</p><span class="tag">Lihat Tata Cara</span>
            </div>
          </div>
          <div class="step">
            <div class="step-num">02</div>
            <div>
              <h3>Tata Cara Pengurusan PBG</h3>
              <p>Siapkan Identitas pemohon, bukti hak atas tanah atau perjanjian pemanfaatan, dan uraian rencana kegiatan beserta perkiraan luas lantai dan lahan.</p><span class="tag">Lihat Tata Cara</span>
            </div>
          </div>
          <div class="step">
            <div class="step-num">03</div>
            <div>
              <h3>Tata Cara Pengurusan SLF</h3>
              <p>Unduh fomulir, isi formulir permohonan lalu unggah dokumen formulir, dan pantau prosesnya secara waktu-nyata dari dashbor Anda.</p><span class="tag">Lihat Tata Cara</span>
            </div>
          </div>
          <div class="step">
          ...
          <div class="step">
            ...
            <div>
              <h3>Tata Cara Pengajuan ITR</h3>
              <p>Konfirmasi atau persetujuan ITR bertanda tangan elektronik terbit ke akun Anda — sah, terverifikasi, dan menjadi dasar perizinan berusaha selanjutnya.</p><span class="tag">Lihat Tata Cara</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="alt">
      <div class="wrap split rev">
        <figure class="photo-frame reveal">
          <img src="https://commons.wikimedia.org/wiki/Special:FilePath/The_tower_of_Darussalam_Grand_Mosque_Cilacap_as_seen_from_Alun-alun_Cilacap_City.jpg?width=1200" alt="Menara Masjid Agung Darussalam dari Alun-alun Cilacap" loading="lazy">
          <figcaption class="photo-cap">Alun-alun Cilacap — ruang publik hasil tata kelola yang tertib</figcaption>
        </figure>
        <div class="reveal">
          <p class="eyebrow">Perlu Diketahui</p>
          <h2>Ketentuan yang Menyertai</h2>
          <div class="list">
            <div class="list-item"><span class="list-key">KKPR Otomatis</span><span class="list-val">Pada kawasan ber-RDTR yang telah terintegrasi OSS, konfirmasi dapat terbit seketika oleh sistem.</span></div>
            <div class="list-item"><span class="list-key">Masa Berlaku</span><span class="list-val">Dokumen KKPR berlaku 3 tahun sejak diterbitkan sebagai dasar perolehan tanah dan perizinan.</span></div>
            <div class="list-item"><span class="list-key">Bantuan</span><span class="list-val">Kesulitan di tahap mana pun? Gunakan layanan <a href="<?php echo base_url('konsultasi'); ?>" style="color:var(--gold-300)">Konsultasi</a> — kami dampingi sampai tuntas.</span></div>
          </div>
        </div>
      </div>
    </section>
