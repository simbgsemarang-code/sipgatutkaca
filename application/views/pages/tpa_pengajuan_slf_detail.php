...
<title>Tinjau Permohonan SLF — Portal TPA · SIP Gatutkaca</title>
...
<section style="padding-top:100px">
  <div class="dash-wrap">
    <p class="eyebrow"><a href="<?php echo base_url('tpa-pengajuan-slf'); ?>" style="color:var(--gold-500);text-decoration:underline">← Kembali ke Daftar Permohonan</a></p>
    ...
    <p style="margin-top:16px"><a href="<?php echo base_url('tpa-pengajuan-slf/checklist/' . (int) $row['id']); ?>" style="color:var(--gold-300);text-decoration:underline;font-size:.85rem">Lihat Checklist Kelengkapan Persyaratan →</a></p>
          ...
          <?php if ($judul_grup === 'Bidang Struktur & Sipil' && !empty($row['tanah_lampiran'])): ?>
            <div class="doc-review-item">
              <div class="doc-review-main">
                ...
                <div class="doc-right">
                  <a href="<?php echo base_url('tpa-pengajuan-slf/berkas/tanah_lampiran/' . (int) $row['id']); ?>" target="_blank" rel="noopener noreferrer">Lihat</a>
                </div>
              </div>
            </div>
          <?php endif; ?>
            ...
            <div class="doc-review-item">
              <div class="doc-review-main">
                ...
                <div class="doc-right">
                  ...
                  <a href="<?php echo base_url('tpa-pengajuan-slf/berkas/dokumen/' . (int) $d['id']); ?>" target="_blank" rel="noopener noreferrer">Lihat</a>
                </div>
              </div>
              ...
              <?php if ($d['status'] === 'ditolak'): ?>
                ...
                <?php if (!empty($bisa_ditandai)): ?>
                  <form action="<?php echo base_url('tpa-pengajuan-slf/tandai-dokumen/' . (int) $d['id']); ?>" method="post" style="margin-top:8px">
              ...
              <?php elseif (!empty($bisa_ditandai)): ?>
                <details class="tandai-form">
                  ...
                  <form action="<?php echo base_url('tpa-pengajuan-slf/tandai-dokumen/' . (int) $d['id']); ?>" method="post">
    ...
    <?php if (!empty($bidang_boleh_menilai)): ?>
      <div class="card">
        ...
        <form class="keputusan-form" action="<?php echo base_url('tpa-pengajuan-slf/kirim-catatan/' . (int) $row['id']); ?>" method="post">
          <div class="opt-list">
            <label>
