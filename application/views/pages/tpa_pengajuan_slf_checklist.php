...
<section style="padding-top:100px">
  <div class="dash-wrap">
    <p class="eyebrow"><a href="<?php echo base_url('tpa-pengajuan-slf/lihat/' . (int) $row['id']); ?>" style="color:var(--gold-500);text-decoration:underline">← Kembali ke Detail Permohonan</a></p>
