...
<title>Pengaturan Panel Login — Panel Admin · SIP Gatutkaca</title>
...
.status-row{display:flex;align-items:center;gap:14px;flex-wrap:wrap;margin-bottom:22px}
...
<section style="padding-top:20px">
  <div class="dash-wrap">
    ...
    <h2>Pengaturan Panel Login</h2>
    <p style="color:var(--muted);max-width:64ch;margin-top:14px">Atur apakah panel kredensial akun uji coba (email + kata sandi demo) ikut ditampilkan di halaman login publik. Panel ini hanya pernah muncul selama server berjalan di lingkungan development - saklar ini menambah kendali supaya admin bisa mematikannya kapan pun tanpa harus mengubah kode.</p>
    ...
    <div class="card">
      ...
      <div class="status-row">
        <span>Panel kredensial akun uji coba di halaman login:</span>
        <span class="badge <?= $tampilkan ? 'badge-on' : 'badge-off' ?>"><?= $tampilkan ? 'Ditampilkan' : 'Disembunyikan' ?></span>
      </div>

      <form method="post" action="<?= base_url('admin/simpan-pengaturan-login') ?>">
        <div class="switch-row">
          <label><input type="checkbox" name="tampilkan_akun_uji" value="1" <?= $tampilkan ? 'checked' : '' ?>> Tampilkan panel kredensial akun uji coba di halaman login</label>
        </div>
