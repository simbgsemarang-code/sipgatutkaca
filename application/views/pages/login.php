...
<section style="padding-top:calc(84px + 100px)">
  <div class="wrap">
    <div class="form-card center reveal">
      ...
      <div class="field"><label for="l-user">NIK / Surel</label><input id="l-user" type="text" placeholder="Nomor Induk Kependudukan atau surel"></div>
      <div class="field"><label for="l-pass">Kata Sandi</label><input id="l-pass" type="password" placeholder="••••••••"></div>
      <button class="btn btn-gold" type="button" style="width:100%">Masuk</button>
      <p class="note" style="text-align:center">Belum memiliki akun? <a href="#" style="color:var(--gold-300);text-decoration:underline">Daftar</a> · <a href="#" style="color:var(--gold-300);text-decoration:underline">Lupa kata sandi</a></p>
      <p class="note" style="text-align:center">Contoh antarmuka — autentikasi aktif setelah terhubung ke sistem kependudukan.</p>
    </div>
  </div>
</section>
