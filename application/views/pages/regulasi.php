...
<title>Regulasi — SIP Gatutkaca · Kabupaten Cilacap</title>
...
<section style="padding-top:calc(84px + 100px)">
  <div class="wrap">
    <div class="reveal">
      <p class="eyebrow">Pustaka Regulasi</p>
      <h2>Aturan yang Terbuka bagi Semua</h2>
    ...
    <table class="reveal">
      <thead><tr><th>Produk Hukum</th><th>Perihal</th><th>Status</th><th></th></tr></thead>
      <tbody>
        <tr><td>Perda RTRW Kabupaten Cilacap</td><td>Rencana Tata Ruang Wilayah Kabupaten beserta lampiran peta dan indikasi program.</td><td><span class="tag">Berlaku</span></td><td><a class="dl" href="#">Unduh ↓</a></td></tr>
        <tr><td>RDTR Kawasan Perkotaan Cilacap</td><td>Rencana Detail Tata Ruang beserta peraturan zonasi kawasan perkotaan Cilacap.</td><td><span class="tag">Berlaku</span></td><td><a class="dl" href="#">Unduh ↓</a></td></tr>
        <tr><td>RDTR Kawasan Perkotaan Kroya</td><td>Rencana Detail Tata Ruang kawasan perkotaan Kroya dan sekitarnya.</td><td><span class="tag">Berlaku</span></td><td><a class="dl" href="#">Unduh ↓</a></td></tr>
        <tr><td>RDTR Kawasan Perkotaan Majenang</td><td>Rencana Detail Tata Ruang kawasan perkotaan Majenang dan sekitarnya.</td><td><span class="tag">Penyusunan</span></td><td><a class="dl" href="#">Ringkasan ↓</a></td></tr>
        <tr><td>Perbup Ketentuan Zonasi</td><td>Ketentuan teknis intensitas dan tata bangunan sebagai dasar penerbitan KKPR.</td><td><span class="tag">Berlaku</span></td><td><a class="dl" href="#">Unduh ↓</a></td></tr>
        <tr><td>Perda Bangunan Gedung</td><td>Pengaturan penyelenggaraan bangunan gedung di wilayah Kabupaten Cilacap.</td><td><span class="tag">Berlaku</span></td><td><a class="dl" href="#">Unduh ↓</a></td></tr>
      </tbody>
    </table>
    <p class="note reveal">Daftar bersifat contoh tampilan; sambungkan ke JDIH Kabupaten Cilacap untuk data resmi dan termutakhir.</p>
  </div>
</section>
...
<section class="alt">
  <div class="wrap split">
    <div class="reveal">
      <p class="eyebrow">Hierarki Aturan</p>
      <h2>Dari Wilayah hingga Persil</h2>
      <div class="list">
        <div class="list-item"><span class="list-key">RTRW</span><span class="list-val">Kerangka besar ruang kabupaten: struktur ruang, pola ruang, dan kawasan strategis untuk dua puluh tahun.</span></div>
        <div class="list-item"><span class="list-key">RDTR</span><span class="list-val">Rincian blok demi blok pada kawasan perkotaan — menjadi dasar langsung penerbitan KKPR.</span></div>
        <div class="list-item"><span class="list-key">Peraturan Zonasi</span><span class="list-val">Ketentuan kegiatan yang diperbolehkan, bersyarat, atau dilarang pada tiap zona.</span></div>
      </div>
    </div>
    <figure class="photo-frame reveal">
      ...
      <figcaption class="photo-cap">Benteng Pendem — saksi tata kelola ruang lintas zaman</figcaption>
    </figure>
  </div>
</section>
